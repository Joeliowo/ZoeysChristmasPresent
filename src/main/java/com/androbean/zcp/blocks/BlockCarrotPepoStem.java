...
public class BlockCarrotPepoStem extends BlockStem {

    public BlockCarrotPepoStem(Block crop) {
        super(crop);
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        drops.add(new ItemStack(ZModItems.CARROT_SEEDS));
        if(this.getMetaFromState(state) == 7) {
            EntityCarrotPepo pepo = new EntityCarrotPepo((World) world);
            ...
            drops.add(new ItemStack(ZModItems.CARROT_SEEDS, 2));
        }
    }
}

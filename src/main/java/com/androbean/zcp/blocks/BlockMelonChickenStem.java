...
public class BlockMelonChickenStem extends BlockStem {

    public BlockMelonChickenStem(Block crop) {
        super(crop);
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        drops.add(new ItemStack(ZModItems.CHICKEN_SEEDS));
        if(this.getMetaFromState(state) == 7) {
            EntityMelonChicken pepo = new EntityMelonChicken((World) world);
            ...
            drops.add(new ItemStack(ZModItems.CHICKEN_SEEDS, 2));
        }
    }
}

...
public class BlockPotatoChickenStem extends BlockStem {

    public BlockPotatoChickenStem(Block crop) {
        super(crop);
    }
    ...
    public void getDrops(NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune) {
        ...
        drops.add(new ItemStack(ZModItems.POTATO_CHICKEN_SEEDS));
        if(this.getMetaFromState(state) == 7) {
            EntityPotatoChicken pepo = new EntityPotatoChicken((World) world);
            ...
            drops.add(new ItemStack(ZModItems.POTATO_CHICKEN_SEEDS, 2));
        }
    }
}

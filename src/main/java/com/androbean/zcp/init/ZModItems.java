...
public class ZModItems {
    ...
    public static final ItemSeeds PUMPKIN_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.MELON_STEM, Blocks.FARMLAND).setUnlocalizedName("pumpkin_pepo_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_PEPO_SEEDS);
    public static final ItemSeeds PUMPKIN_CHICKEN_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.CHICKEN_STEM, Blocks.GRASS).setUnlocalizedName("pumpkin_chicken_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_ANIMAL_SEEDS);
    ...
    public static final ItemSeeds WHEAT_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.MELON_STEM, Blocks.FARMLAND).setUnlocalizedName("wheat_pepo_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_PEPO_SEEDS);
    public static final ItemSeeds WHEAT_CHICKEN_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.CHICKEN_STEM, Blocks.GRASS).setUnlocalizedName("wheat_chicken_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_ANIMAL_SEEDS);
    ...
    public static final ItemSeeds POTATO_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.MELON_STEM, Blocks.FARMLAND).setUnlocalizedName("potato_pepo_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_PEPO_SEEDS);
    public static final ItemSeeds POTATO_CHICKEN_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.CHICKEN_STEM, Blocks.GRASS).setUnlocalizedName("potato_chicken_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_ANIMAL_SEEDS);
    ...
    public static final ItemSeeds CARROT_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.MELON_STEM, Blocks.FARMLAND).setUnlocalizedName("carrot_pepo_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_PEPO_SEEDS);
    public static final ItemSeeds CARROT_CHICKEN_SEEDS = (ItemSeeds) new ItemSeeds(ZModBlocks.CHICKEN_STEM, Blocks.GRASS).setUnlocalizedName("carrot_chicken_seeds").setCreativeTab(ZModCreativeTabs.CREATIVE_TAB_ANIMAL_SEEDS);

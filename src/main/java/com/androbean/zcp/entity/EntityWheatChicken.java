...
public class EntityWheatChicken extends EntityPepoAnimal {
    public int eggCounter;

    public EntityWheatChicken(World world){
        super(world);
        if(this.getAge() == 0) {
        ...
        this.seedItem = ZModItems.WHEAT_CHICKEN_SEEDS;
        this.dropItem = ZModItems.ANIMAL_WHEAT;
        this.stem = ZModBlocks.WHEAT_CHICKEN_STEM;
    }

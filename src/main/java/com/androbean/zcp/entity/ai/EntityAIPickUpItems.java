...
public class EntityAIPickUpItems extends EntityAIBase {
    ...
    public EntityAIPickUpItems(EntityPepoVillager entityIn, double movementSpeedIn) {
        this.gem = entityIn;
    ...
    public boolean shouldExecute() {
        ...
        for (EntityItem item : list) {
            ...
            if (newDistance <= maxDistance && this.gem.getJob() == "farmer" &&this.gem.canEntityBeSeen(item) && !item.isDead) {

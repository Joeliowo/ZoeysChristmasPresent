...
public class EntityCarrotChicken extends EntityPepoAnimal {
    public int eggCounter;

    public EntityCarrotChicken(World world){
        super(world);
        if(this.getAge() == 0) {
        ...
        this.seedItem = ZModItems.CARROT_CHICKEN_SEEDS;
        this.dropItem = ZModItems.ANIMAL_CARROT;
        this.stem = ZModBlocks.CARROT_CHICKEN_STEM;
    }

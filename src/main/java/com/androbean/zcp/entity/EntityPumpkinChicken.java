...
public class EntityPumpkinChicken extends EntityPepoAnimal {
    public int eggCounter;

    public EntityPumpkinChicken(World world){
        super(world);
        if(this.getAge() == 0) {
        ...
        this.seedItem = ZModItems.PUMPKIN_CHICKEN_SEEDS;
        this.dropItem = ZModItems.ANIMAL_PUMPKIN;
        this.stem = ZModBlocks.PUMPKIN_CHICKEN_STEM;
    }
